...
>(({ className, rangeLow, rangeHigh, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <SliderPrimitive.Thumb className="relative block h-4 w-16 rounded-md border border-black bg-cyan-600 ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50">
        <div className="absolute -top-2 left-0 h-8 w-2 rounded-sm border border-black bg-cyan-600"></div>
        <div className="absolute -left-3 -top-7 text-xs">{rangeLow}</div>
        <div className="absolute -top-2 right-0 h-8 w-2 rounded-sm border border-black bg-cyan-600"></div>
        <div className="absolute -right-3 -top-7 text-xs">{rangeHigh}</div>
